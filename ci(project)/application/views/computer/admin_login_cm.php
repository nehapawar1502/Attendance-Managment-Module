<?php include('admin_login_header.php'); ?>

<div class="container">
<?php 
//echo "<form action='login/admin_login' method='post' class='form-horizontal'>";
 echo form_open('Login/admin_login_valid_cm',['class'=>'form-horizontal']); 
?>

    <div class="row">
      <div class="col-lg-6 col-lg-offset-6">
         <?= anchor('dept','Home',['class'=>'btn btn-lg btn-primary pull-right']) ?>
      </div> 
    </div>
    <fieldset>
