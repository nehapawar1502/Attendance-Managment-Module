...
//echo "<form action='login/admin_login' method='post' class='form-horizontal'>";
 echo form_open("admin/update_staff_cm/{$staffs->id}",['class'=>'form-horizontal']); 
 ?>


    <fieldset>
    <legend>Edit Staff and Subject</legend>
    ...
    <div class="row">
        ...
        <label for="inputEmail" class="col-lg-4 control-label"> Staff Name</label>
            <div class="col-lg-8">
            <?php echo form_input(['name'=>'Staff_Name','class'=>'form-control','placeholder'=>'Enter Staff Name','value'=>set_value('Staff_Name',$staffs->Staff_Name)]); ?>
            </div>
        </div>
     </div>
      <div class="col-lg-6">
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <label for="inputEmail" class="col-lg-4 control-label">subject</label>
            <div class="col-lg-8">
            <?php echo form_input(['name'=>'Subject','class'=>'form-control','placeholder'=>'Enter Subject','value'=>set_value('Subject',$staffs->Subject)]); ?>
            </div>
        </div>
     </div>
      <div class="col-lg-6">
      ...
      <div class="col-lg-6">
        ...
        <label for="inputEmail" class="col-lg-4 control-label"> Year</label>
            <div class="col-lg-8">
            <?php echo form_input(['name'=>'b_year','class'=>'form-control','placeholder'=>'Enter Year','value'=>set_value('year',$staffs->b_year)]); ?>
            </div>
        </div>
     </div>
      <div class="col-lg-6">
